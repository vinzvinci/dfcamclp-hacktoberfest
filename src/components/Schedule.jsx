      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl lg:pr-24">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-blue-900">
            Get ready for an exciting lineup of events at our campus Hacktoberfest! We can’t wait to see you there as we dive into a month filled with innovation, coding, and open–source contributions.
          </p>
        </div>
      </Container>
